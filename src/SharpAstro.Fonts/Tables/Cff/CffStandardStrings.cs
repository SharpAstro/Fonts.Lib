...
/// <summary>
/// The 391 CFF standard strings (Adobe Tech Note #5176 Appendix A). SIDs 0–390 index this
/// table; SID 391 and up index the font's own String INDEX. Needed to resolve a PostScript
/// glyph name to a SID when looking a glyph up by name through the charset.
/// </summary>
internal static class CffStandardStrings
{
    public const int Count = 391;

    /// <summary>SID of <paramref name="name"/> among the standard strings, or -1.</summary>
    public static int IndexOf(string name)
        => Lookup.TryGetValue(name, out var sid) ? sid : -1;

    public static string Get(int sid) => Names[sid];
    ...
    [
        ...
        "ordfeminine", "Lslash", "Oslash", "OE", "ordmasculine", "ae", "dotlessi",
        "lslash", "oslash", "oe", "germandbls", "onesuperior", "logicalnot", "mu",
        "trademark", "Eth", "onehalf", "plusminus", "Thorn", "onequarter", "divide",
        ...
        "Circumflexsmall", "hyphensuperior", "Gravesmall", "Asmall", "Bsmall", "Csmall",
    ...
    // Declared after Names: static fields initialize in declaration order, and this
    // builder reads it.
    ...
    private static Dictionary<string, int> BuildLookup()
    {
        ...
        for (var i = 0; i < Names.Length; i++)
            map[Names[i]] = i; // duplicates impossible: the standard set is distinct
        return map;
    }
}
